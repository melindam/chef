#!/usr/bin/env ruby
#
# Copy for Optum / John Muir Health version of mailer handler
# Sensu Handler: pdmailer
#
...
class Mailer < Sensu::Handler
  ...
  # file for pdmailer. JSON Config Name defaultly looks for a block
  # named 'pdmailer', as seen in the Installation step of the README
  #
  # @example
  #
  # ```json
