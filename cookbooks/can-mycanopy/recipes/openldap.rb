...
node.set['openldap']['rootpw'] = secure_password unless node['openldap']['rootpw']
...
ruby_block 'Encode Root Password' do
  block do
    ...
    node.set['openldap']['rootpw_encoded'] = command_out.stdout.chomp
  end
  action :create
...
node['can_mycanopy']['openldap']['service_accounts'].each_key do |sa|
  ...
  unless node['can_mycanopy']['openldap']['service_accounts'][sa]['password']
    node.set['can_mycanopy']['openldap']['service_accounts'][sa]['password'] = secure_password
  end
